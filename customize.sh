...
# sed -i 's/$(VERSION_DIST_SANITIZED)/$(shell TZ=UTC-8 date +%Y%m%d)-OpenWrt/g' include/image.mk
# echo "DISTRIB_REVISION='$(TZ=UTC-8 date +%y.%m) Compiled by zhangdi '" > ./package/base-files/files/etc/openwrt_release1
